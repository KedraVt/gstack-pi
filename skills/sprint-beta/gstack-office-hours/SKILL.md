...
Use before /skill:gstack-plan-ceo-review or /skill:gstack-plan-eng-review.
...
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-timeline-log '{"skill":"office-hours","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
B=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/browse/dist/browse" ] && B="$_ROOT/C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/browse/dist/browse"
[ -z "$B" ] && B="C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/browse/dist/browse"
if [ -x "$B" ]; then
  echo "READY: $B"
else
  echo "NEEDS_SETUP"
...
2. Run: `cd C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source && ./setup`
...
eval "$(C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-slug 2>/dev/null)" 2>/dev/null || true
{
  ...
  printf '\n### %s\n\n' "salience"
  C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/bin/gstack-brain-cache get salience --project "$SLUG" 2>/dev/null || printf '_(no salience digest available yet)_\n'
...
After understanding the problem through questioning, search for what the world thinks. This is NOT competitive research (that's /skill:gstack-design-consultation's job). This is understanding conventional wisdom so you can evaluate where it's wrong.
...
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
D=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/design/dist/design" ] && D="$_ROOT/C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/design/dist/design"
[ -z "$D" ] && D="C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/design/dist/design"
...
(`/skill:gstack-plan-design-review`, `/skill:gstack-design-review`) to see what was originally envisioned.
...
```bash
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-developer-profile --log-session '{"date":"TIMESTAMP","mode":"MODE","project_slug":"SLUG","signal_count":N,"signals":SIGNALS_ARRAY,"design_doc":"DOC_PATH","assignment":"ASSIGNMENT_TEXT","resources_shown":[],"topics":TOPICS_ARRAY}' 2>/dev/null || true
```
...
> **STOP.** Before writing the design doc and running the tiered relationship handoff (Phases 5-6, after the conversation and alternatives are done), Read `C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/office-hours/sections/design-and-handoff.md` and execute it
...
```bash
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/bin/gstack-learnings-log '{"skill":"office-hours","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```

...
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-timeline-log '{"skill":"learn","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
- `/skill:gstack-learn` (no arguments) → **Show recent**
- `/skill:gstack-learn search <query>` → **Search**
- `/skill:gstack-learn prune` → **Prune**
- `/skill:gstack-learn export` → **Export**
- `/skill:gstack-learn stats` → **Stats**
- `/skill:gstack-learn add` → **Manual add**
...
```bash
eval "$(C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-slug 2>/dev/null)"
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-learnings-search --limit 20 2>/dev/null || echo "No learnings yet."
```

Present the output in a readable format. If no learnings exist, tell the user:
"No learnings recorded yet. As you use /skill:gstack-review, /skill:gstack-ship, /skill:gstack-investigate, and other skills,
...
```bash
eval "$(C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-slug 2>/dev/null)"
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-learnings-search --query "USER_QUERY" --limit 20 2>/dev/null || echo "No matches."
```
...
```bash
eval "$(C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-slug 2>/dev/null)"
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-learnings-search --limit 100 2>/dev/null
```
...
```bash
eval "$(C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-slug 2>/dev/null)"
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-learnings-search --limit 50 2>/dev/null
```
...
```bash
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/bin/gstack-learnings-log '{"skill":"learn","type":"TYPE","key":"KEY","insight":"INSIGHT","confidence":N,"source":"user-stated","files":["FILE1"]}'
```

...
metadata:
  ...
  source: plan-devex-review/SKILL.md
---
# Pi adapter note
...
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-timeline-log '{"skill":"plan-devex-review","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
# /skill:gstack-plan-devex-review: Developer Experience Plan Review
...
\`C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/plan-devex-review/dx-hall-of-fame.md\`
...
"This plan doesn't appear to have developer-facing surfaces. /skill:gstack-plan-devex-review
reviews plans for APIs, CLIs, SDKs, libraries, platforms, and docs. Consider
/skill:gstack-plan-eng-review or /skill:gstack-plan-design-review instead." Exit gracefully.
...
eval "$(C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-slug 2>/dev/null)" 2>/dev/null || true
{
  ...
  printf '\n### %s\n\n' "developer-persona"
  C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/bin/gstack-brain-cache get developer-persona --project "$SLUG" 2>/dev/null || printf '_(no developer-persona digest available yet)_\n'
  printf '\n### %s\n\n' "recent-decisions"
  ...
  printf '\n### %s\n\n' "competitive-intel"
  C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/bin/gstack-brain-cache get competitive-intel --project "$SLUG" 2>/dev/null || printf '_(no competitive-intel digest available yet)_\n'
...
Load the "## Pass 1" section from `C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/plan-devex-review/dx-hall-of-fame.md`
...
> **STOP.** Before running the 8 DX passes, required outputs, and review report (only after Step 0 investigation is complete), Read `C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/plan-devex-review/sections/review-sections.md` and execute it

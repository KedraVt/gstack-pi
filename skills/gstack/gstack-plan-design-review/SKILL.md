...
visual audits, use /skill:gstack-design-review. Use when asked to "review the design plan"
or "design critique".
...
C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-timeline-log '{"skill":"plan-design-review","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
# /skill:gstack-plan-design-review: Designer's Eye Plan Review
...
eval "$(C:/Users/Mattia/.pi/agent/extensions/gstack-pi/runtime/bin/gstack-slug 2>/dev/null)" 2>/dev/null || true
{
  ...
  printf '\n### %s\n\n' "brand"
  C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/bin/gstack-brain-cache get brand --project "$SLUG" 2>/dev/null || printf '_(no brand digest available yet)_\n'
  printf '\n### %s\n\n' "recent-decisions"
...
- If no DESIGN.md: "No design system found. Recommend running /skill:gstack-design-consultation first. Proceeding with universal design principles."
...
fewer variants and benefits from sequential control. Note: /skill:gstack-design-shotgun uses
...
Re-run loop: invoke /skill:gstack-plan-design-review again → re-rate → sections at 8+ get a quick pass, sections below 8 get full treatment.
...
> **STOP.** Before running the 7 design passes, required outputs, and review report (only after Step 0 scope is agreed), Read `C:/Users/Mattia/.pi/agent/extensions/gstack-pi/source/plan-design-review/sections/review-sections.md` and execute it

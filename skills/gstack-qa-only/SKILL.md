...
C:/Users/Mattia/.pi/agent/gstack-pi/repo/bin/gstack-timeline-log '{"skill":"qa-only","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
C:/Users/Mattia/.pi/agent/gstack-pi/repo/bin/gstack-question-log '{"skill":"qa-only","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
...
3. Copy report template from `C:/Users/Mattia/.pi/agent/gstack-pi/repo/qa/templates/qa-report-template.md` to output dir
...
Then follow the **per-page exploration checklist** (see `C:/Users/Mattia/.pi/agent/gstack-pi/repo/qa/references/issue-taxonomy.md`):
...
**Write each issue to the report immediately** using the template format from `C:/Users/Mattia/.pi/agent/gstack-pi/repo/qa/templates/qa-report-template.md`.
...
```bash
C:/Users/Mattia/.pi/agent/gstack-pi/repo/bin/gstack-learnings-log '{"skill":"qa-only","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
